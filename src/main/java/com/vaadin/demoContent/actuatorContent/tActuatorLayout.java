...
public class tActuatorLayout extends VerticalLayout {
    ...
    tLastMeasureLayout DeviceLastState;
    tMeasuresJournalLayout MeasureJournal;
    tActuatorTaskLayout actuatorTaskLayout;
    DiagramLayout actuatorGraphLayout;
    ...
    public tActuatorLayout(int eUserDeviceId, String eLeafName, int eLeafId,tTreeContentLayout eParentContentLayout){
        ...
        DeviceLastState = new tLastMeasureLayout(iUserDeviceId,"ACTUATOR");
        MeasureJournal = new tMeasuresJournalLayout(iUserDeviceId,"ACTUATOR");
        actuatorGraphLayout = new DiagramLayout(
                iUserDeviceId
                ,"DETECTOR"
                ,"текст"
        );
